...
rainfall_1 <-  rainfall %>%
  filter(date >= "1967-01-01", date <= "2018-12-31") %>%
...
p1<-ggplot(data = combined_avg_rt) +
  geom_point(mapping = aes(y = rainfall, x = date_yearly),size=0.5, colour="blue")+
  geom_point(mapping = aes(y=min_temperature/1.5, x = date_yearly),size=0.001,alpha=0.75, colour="red") +
  geom_point(mapping = aes(y=max_temperature/1.5, x = date_yearly),size=0.001,alpha=0.75, colour="black") +
